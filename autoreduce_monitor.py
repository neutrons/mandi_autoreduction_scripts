...
class Example(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.lbl2 = QtGui.QLabel('Last Run Processed: {0}'.format(lastRun), self)
        ...
        self.lbl4 = QtGui.QLabel('Currently reading IPTS {}'.format(ipts_reading), self)
    ...
    def Time(self):
        ...
        if 'Finished' in line:
            ...
            self.lbl3.setText("Time since last finished analysis: {}".format(str(dt)))
        else:
            self.lbl2.setText("Started processing at {}".format(str(datemod)))
            self.lbl3.setText("Time since started analysis: {}".format(str(dt)))        
        self.lbl4.setText("Currently scanning IPTS {}".format(str(ipts_reading)))
def main():
